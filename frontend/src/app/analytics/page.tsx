      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          <StatCard
            ...
            isPositive={true}
            backgroundSvg={
              <svg className="absolute -bottom-0 -right-0 opacity-[0.1]" width="81" height="81" viewBox="0 0 81 81" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <StatCard
            ...
            isPositive={true}
            backgroundSvg={
              <svg className="absolute -bottom-0 -right-0 opacity-[0.1]" width="85" height="64" viewBox="0 0 85 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <StatCard
            ...
            isPositive={false}
            backgroundSvg={
              <svg className="absolute -bottom-0 -right-0 opacity-[0.1]" width="80" height="84" viewBox="0 0 80 84" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <StatCard
            ...
            changeColor="#FFFFFF"
            backgroundSvg={
              <svg className="absolute -bottom-0 -right-0 opacity-20" width="38" height="72" viewBox="0 0 38 72" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 ">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h3 className="text-lg font-bold text-[#191C1E]">Performance Over Time</h3>
              <p className="text-sm text-[#505F76]">Aggregate performance metrics across all channels</p>
            </div>
              ...
              {(['earnings', 'clicks', 'referrals'] as const).map((view) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-xs font-semibold capitalize transition-all ${
                    chartView === view ? 'bg-white text-[#050C9C] ' : 'text-[#505F76] hover:text-gray-700'
                  }`}
                >
                  {view}
                </button>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="col-span-2 bg-white rounded-2xl border border-gray-100 p-6 ">
            <h3 className="text-sm font-bold uppercase tracking-wider text-[#505F76] mb-6">Clicks Per Day</h3>
          ...
          <div className="col-span-1 bg-white rounded-2xl border border-gray-100 p-6 ">
            <h3 className="text-sm font-bold uppercase tracking-wider text-[#505F76] mb-8">Traffic Sources</h3>
              ...
              <div className="w-[160px] h-[160px] relative mb-8">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <p className="text-sm text-[#9CA3AF] font-medium mb-1">Total</p>
              ...
              <div className="space-y-4 w-full">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#6B7280]">Social</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#6B7280]">Referral</span>
                  </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl border border-gray-100 p-6 ">
            <h3 className="text-sm font-bold uppercase tracking-wider text-[#505F76] mb-6">User Conversion Funnel</h3>
            <div className="space-y-4">
              <FunnelStep step="01" label="Total Clicks" sub="Entrance visitors" value={(s?.total_clicks || 0).toLocaleString()} color="bg-[#050C9C] text-white" />
              <FunnelStep step="02" label="Referrals" sub={`${s?.conversion_rate || 0}% conversion`} value={(s?.total_referrals || 0).toLocaleString()} color="bg-[#050C9C] text-white" />
              <FunnelStep step="03" label="Subscriptions" sub="0.65% retention" value="0" color="bg-[#050C9C] text-white" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 ">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-sm font-bold uppercase tracking-wider text-[#191C1E]">Growth Insights</h3>
            </div>
            <div className="space-y-4">
              <InsightCard
...
<path d="M4 18V16H8V12.9C7.18333 12.7167 6.45417 12.3708 5.8125 11.8625C5.17083 11.3542 4.7 10.7167 4.4 9.95C3.15 9.8 2.10417 9.25417 1.2625 8.3125C0.420833 7.37083 0 6.26667 0 5V4C0 3.45 0.195833 2.97917 0.5875 2.5875C0.979167 2.19583 1.45 2 2 2H4V0H14V2H16C16.55 2 17.0208 2.19583 17.4125 2.5875C17.8042 2.97917 18 3.45 18 4V5C18 6.26667 17.5792 7.37083 16.7375 8.3125C15.8958 9.25417 14.85 9.8 13.6 9.95C13.3 10.7167 12.8292 11.3542 12.1875 11.8625C11.5458 12.3708 10.8167 12.7167 10 12.9V16H14V18H4ZM4 7.8V4H2V5C2 5.63333 2.18333 6.20417 2.55 6.7125C2.91667 7.22083 3.4 7.58333 4 7.8ZM9 11C9.83333 11 10.5417 10.7083 11.125 10.125C11.7083 9.54167 12 8.83333 12 8V2H6V8C6 8.83333 6.29167 9.54167 6.875 10.125C7.45833 10.7083 8.16667 11 9 11ZM14 7.8C14.6 7.58333 15.0833 7.22083 15.45 6.7125C15.8167 6.20417 16 5.63333 16 5V4H14V7.8Z" fill="#050C9C"/>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 ">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-sm font-bold uppercase tracking-wider text-[#505F76]">Top Performing Links</h3>
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              {(!data?.top_links || data.top_links.length === 0) && (
                <tr><td colSpan={4} className="px-4 py-8 text-center text-[#505F76] text-sm">No link data yet</td></tr>
              )}
            </tbody>
          </table>
        </div>
