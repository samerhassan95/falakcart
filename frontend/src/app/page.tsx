    ...
    <AppLayout>
      <div className="flex items-center justify-center h-[60vh]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-gray-400 text-sm font-medium">{t('Loading dashboard...')}</p>
        </div>
      </div>
    </AppLayout>
  );
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">{t('dashboard.performanceOverview')}</p>
          </div>
            ...
            <div className="relative">
              ...
              {showPeriodMenu && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-100 rounded-2xl shadow-xl py-2 z-50">
                  {[t('dashboard.today'), t('dashboard.thisWeek'), t('dashboard.thisMonth'), t('dashboard.allTime')].map(p => (
                    <button 
                      key={p} 
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            ...
            <p className="text-sm text-gray-500 mb-3">{t('dashboard.monthlyTarget', { target: goalTarget.toLocaleString() })}</p>
            ...
            <p className="text-sm text-gray-500">
              <span className="font-semibold text-gray-900">{t('dashboard.greatJob')}</span> {t('dashboard.awayFromGoal', { amount: Math.max(0, goalTarget - (stats?.earnings || 0)).toLocaleString() })}
            </p>
          </div>
        </div>
